...
#  time – час повідомлення(використайте модуль datetime) приклад datetime.strptime('10:23', '%H:%M')
# методи:
...
#
#
# message1 = Message("Rony", "Hi", "16:00")
# message2 = Message("Marry", "No", "21:01")
# message3 = Message("Rony", "Why?", "22:02")
#
